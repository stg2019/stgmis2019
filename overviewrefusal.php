        ...
        <div id="page-container" class="fade page-without-sidebar page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <h1 class="page-header">               
                    Refusal for Treatment Overview
                    ...
                    <div class="col-md-8">
                        <div class="panel panel-info" >
                            <div class="panel-heading ">
                                <h4 class="panel-title">Refusal of Treatment</h4>
                                <?php
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label >Signed</label>
                                            <input type="text" class="form-control input-sm" value="<?php echo $fetch['signed']; ?>" id="usigned<?php echo $fetch['refusal_treatment_id']; ?>" name="witness1" placeholder="Enter Witness 1 Name" required readonly/>
                                        </div>
                                        <div class="form-group">
