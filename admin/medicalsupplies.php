    ...
    <body>
        ...
        <div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-light-sidebar">
            ...
            <div id="content" class="content">
                ...
                <h1 class="page-header"><a href="#addmedicalsupply" class="btn btn-sm btn-primary" data-toggle="modal">New Supply</a></h1>
            ...
            <?php require '../modals/addmedicalsupplies.php'?>
