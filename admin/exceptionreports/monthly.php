<div class="colmonth barmonth linemonth piemonth doughnutmonth reporttype">
    ...
    <table id="emttable" class="table table-bordered table-condensed nowrap" width="100%">
        ...
        <tbody>
            ...
            $query = $conn->query("SELECT month, count(*) as count FROM `dispatch` where `year` = '$year' group by month order by count DESC") or die(mysqli_error());
