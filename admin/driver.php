    ...
    <body>
        ...
        <div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-light-sidebar">
            ...
            <div id="content" class="content">
                ...
                <h1 class="page-header"><a href="#newdriver" class="btn btn-sm btn-primary" data-toggle="modal">New Driver</a></h1>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary" >
                            <div class="panel-heading ">
                                <h4 class="panel-title">List of Drivers</h4>
                            </div>
            ...
            <?php require '../modals/newdriver.php'?>
