    ...
    <body>
        ...
        <div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-light-sidebar">
            ...
            <div id="content" class="content">
                ...
                <h1 class="page-header"><a href="#newambulance" class="btn btn-sm btn-primary" data-toggle="modal">New Ambulance</a></h1>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary" >
                            <div class="panel-heading ">
                                <h4 class="panel-title">List of Ambulance</h4>
                            </div>
            ...
            <?php require '../modals/newambulance.php'?>
