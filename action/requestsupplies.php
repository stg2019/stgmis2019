...
if(isset($_POST['add'])){
    ...
    $conn->query("INSERT INTO `medical_supply_request` VALUES('', '$medical_supply_name', '$requested_quantity', '$requested_quantity', '$date_requested', 'Pending', '$month', '$year', 'Pending', '$user_id')") or die(mysqli_error());
