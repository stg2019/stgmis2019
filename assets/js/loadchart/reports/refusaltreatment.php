<?php require '../chartqueries/reportsrefusaltreatment.php'?>
<script type="text/javascript"> 
    $(document).ready(function(){ 
        ...
        var chart1 = new CanvasJS.Chart("chartContainer1",{
            ...
            exportFileName: "Monthly Refusal of Treatment Count - BDRRMO", 
            exportEnabled: true,
            toolTip: {
                shared: true  
            },
            ...
            subtitles:[
                {
                    text: "Monthly Refusal of Treatment Count - Year <?php echo $year?>"
                }
            ],
            legend: {
                cursor: "pointer",
            ...
            axisY: { 
                title: "Total Refusal of Treatment", 
                includeZero: false,
                labelFontColor: "black",
            }, 
            data: [ 
        ...
        var chart2 = new CanvasJS.Chart("chartContainer2",{
            ...
            animationDuration: 1000,
            colorSet: "customColorSet",
            exportFileName: "Quarterly Refusal of Treatment Count - BDRRMO", 
            exportEnabled: true,
            toolTip: {
                shared: true  
            },
            ...
            subtitles:[
                {
                    text: "Quarterly Refusal of Treatment Count - Year <?php echo $year?>"
                }
            ],
            legend: {
                cursor: "pointer",
