...
var handleDatepicker = function () {
    ...
    handleIonRangeSlider = function () {
        $("#default_rangeSlider").ionRangeSlider({
            ...
            $("#verbal").ionRangeSlider({
            min: 1,
            max : 5,
            type: "single",
            hasGrid: !0
        }),
            $("#motor").ionRangeSlider({
            min: 1,
            max : 6,
            type: "single",
            hasGrid: !0
        }),
            $("#priority_level").ionRangeSlider({
            min: 1,
            max : 3,
            type: "single",
            hasGrid: !0
    ...
    handleFormMaskedInput = function () {
        "use strict";
        $("#masked-input-date").mask("99/99/9999"), $("#masked-input-phone").mask("(999) 999-9999"), $("#masked-input-tid").mask("99-9999999"), $("#masked-input-ssn").mask("999-99-9999"), $("#bp").mask("999/99"), $("#masked-input-pkey").mask("a*-999-a999")
    },
