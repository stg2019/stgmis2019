...
(function (e) {
    ...
    function f(n) {
        ...
        this.stream = function (l) {
            ...
            function h() {
                ...
                if (i && b(n.complete)) n.complete(c);
                else if (c && c.meta.aborted && b(n.complete)) n.complete(c);
                else if (!i) a()
            }

            function p() {
                if (b(n.error)) n.error(u.statusText);
                else if (t && n.error) {
                    e.postMessage({
                        workerId: Papa.WORKER_ID,
                        error: u.statusText,
    ...
    function l(n) {
        ...
        this.stream = function (u) {
            ...
            function h(o) {
                ...
                if (a && b(n.complete)) n.complete(undefined, u);
                else if (h && h.meta.aborted && b(n.complete)) n.complete(h, u);
                else if (!a) l()
            }

            function p() {
                if (b(n.error)) n.error(o.error, u);
                else if (t && n.error) {
                    e.postMessage({
                        workerId: Papa.WORKER_ID,
                        error: o.error,
    ...
    function c(e) {
        function s() {
            if (i && n) {
                c("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to comma");
                n = false
            }
            if (o()) u();
            return a()
        ...
        function u() {
            ...
            for (var e = 0; o() && e < i.data.length; e++)
                for (var t = 0; t < i.data[e].length; t++) r.push(i.data[e][t]);
            i.data.splice(0, 1)
        }

        function a() {
            if (!i || !e.header && !e.dynamicTyping) return i;
            for (var t = 0; t < i.data.length; t++) {
                var n = {};
                for (var s = 0; s < i.data[t].length; s++) {
                    if (e.dynamicTyping) {
                        var o = i.data[t][s];
                        if (o == "true") i.data[t][s] = true;
                        else if (o == "false") i.data[t][s] = false;
                        else i.data[t][s] = l(o)
                    }
                    if (e.header) {
                        if (s >= r.length) {
                ...
                if (e.header) {
                    i.data[t] = n;
                    if (s > r.length) c("FieldMismatch", "TooManyFields", "Too many fields: expected " + r.length + " fields but parsed " + s, t);
                    else if (s < r.length) c("FieldMismatch", "TooFewFields", "Too few fields: expected " + r.length + " fields but parsed " + s, t)
                }
            }
            if (e.header && i.meta);
            i.meta.fields = r;
    ...
    function h(e) {
        ...
        function x() {
            if (y) I("Abort", "ParseAbort", "Parsing was aborted by the user's step function");
            if (c) I("Quotes", "MissingQuotes", "Unescaped or mismatched quotes");
            _();
            if (!b(o)) return U()
        }
        ...
        function T() {
            if (j() && !B()) c = !c;
                ...
                A();
                if (c && B()) l++;
                else I("Quotes", "UnexpectedQuotes", "Unexpected quotes")
            }
        }
        ...
        function D() {
            if (p[v].length == 1 && n.test(p[v][0])) {
                if (e.keepEmptyRows) p[v].splice(0, 1);
                else p.splice(v, 1);
                v = p.length - 1
            }
        }
        ...
        function P(e) {
            return e < r.length - 1 && (r[e] == "\r" && r[e + 1] == "\n" || r[e] == "\n" && r[e + 1] == "\r")
        }
        ...
        o = e.step;
        a = e.preview;
        if (typeof i !== "string" || i.length != 1 || Papa.BAD_DELIMITERS.indexOf(i) > -1) i = ",";
        if (s === true) s = "#";
        else if (typeof s !== "string" || s.length != 1 || Papa.BAD_DELIMITERS.indexOf(s) > -1 || s == i) s = false;
    ...
    function g(e) {
        ...
        if (typeof t.keepEmptyRows !== "boolean") t.keepEmptyRows = s.keepEmptyRows;
        return t
    }
