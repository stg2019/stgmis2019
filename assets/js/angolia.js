/*!  1.9.0 | © Algolia | github.com/algolia/places */ ! function (t, e) {
    ...
    return function (t) {
        ...
        function u(t, e, n) {
            function r() {
                for (var r, i = 0, s = t.length; !r && i < s; i += 1) r = !1 === t[i].apply(e, n);
                return !r
            }
            return r
        }
        ...
        function n(t, e) {
            ...
            var n = !0 === e.prepend ? "prepend" : "append",
                ...
                u = i.indexOf(a); - 1 === u && (u = i.push(a) - 1, s[u] = {});
            var c;
        ...
        ! function (e, n) {
            t.exports = function (t) {
                var e = function () {
                    ...
                    function g(t, e, n) {
                        for (S in e) n && (o(e[S]) || tt(e[S])) ? (o(e[S]) && !o(t[S]) && (t[S] = {}), tt(e[S]) && !tt(t[S]) && (t[S] = []), g(t[S], e[S], n)) : e[S] !== C && (t[S] = e[S])
                    }
                    ...
                    return G.matches = function (t, e) {
                        ...
                        closest: function (t, e) {
                            ...
                            return this.each(function (s, o) {
                                for (; o && !(r ? r.indexOf(o) >= 0 : G.matches(o, t));) o = o !== e && !i(o) && o.parentNode;
                        ...
                        offsetParent: function () {
                            return this.map(function () {
                                for (var t = this.offsetParent || j.body; t && !H.test(t.nodeName) && "static" == A(t).css("position");) t = t.offsetParent;
                                return t
                            })
                        }
